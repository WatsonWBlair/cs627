...
if [ -z "$DRY_RUN" ]; then
    ...
    echo -e "  4. Pre-generate tokens: ${BLUE}python src/Training/pregenerate_tokens.py${NC}"
    echo -e "  5. Train adapters: ${BLUE}python src/Training/train_adapters.py --mode encoder${NC}"
    echo ""
